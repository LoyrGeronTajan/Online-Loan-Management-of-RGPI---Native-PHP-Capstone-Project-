...
include "lib/config.php";
    ...
    function CellFit($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $scale=false, $force=true)
    {
        ...
        $width_cell=array(48,20,48,48,20);
        
        //Background color of header//
        $pdf->SetFillColor(193,229,252);
        
        
        $pdf->Cell($width_cell[0],10,'Product Description',1,0,'C',true);
        $pdf->Cell($width_cell[1],10,'Qty',1,0,'C',true);
        $pdf->Cell($width_cell[2],10,'Invoice No.',1,0,'C',true);
        $pdf->Cell($width_cell[3],10,'Username',1,0,'C',true);
    
        $pdf->Cell($width_cell[4],10,'Price',1,1,'C',true);
        ...
        $sql="SELECT * From cartorder WHERE status = 2 AND archive = 'NO'";
        ...
        $pdf->CellFitScale(48,'7', $productName,1,0,'L',$fill);

        //$pdf->SetFont('Arial','',12);

        $pdf->CellFitScale(20,'7',$row['order_productqty'] ,'1','0', 'C');
        
        $pdf->CellFitScale(48,'7',$row['invoiceNo'],'1','0', 'C');
        $pdf->CellFitScale(48,'7',$row['username'],'1','0', 'C');
        $pdf->CellFitScale(20,'7',$row['order_productprice'],1,1,'C',$fill);
